...
public class KaNoBuMoveTests
{
    ...
    public void ScoutCanMoveUpToTwoManhattanCells()
    {
        ...
        Assert.That(scout.IsMoveValid(new KaNoBuMoveResponseModel.MoveStep(
            new Point { X = 1, Y = 1 },
            new Point { X = 1, Y = 3 })), Is.True);
        Assert.That(scout.IsMoveValid(new KaNoBuMoveResponseModel.MoveStep(
            new Point { X = 1, Y = 1 },
            new Point { X = -1, Y = 1 })), Is.True);
        Assert.That(scout.IsMoveValid(new KaNoBuMoveResponseModel.MoveStep(
            new Point { X = 1, Y = 1 },
            new Point { X = 1, Y = -1 })), Is.True);
        Assert.That(scout.IsMoveValid(new KaNoBuMoveResponseModel.MoveStep(
            new Point { X = 1, Y = 1 },
            new Point { X = 2, Y = 0 })), Is.True);
        Assert.That(scout.IsMoveValid(new KaNoBuMoveResponseModel.MoveStep(
            new Point { X = 1, Y = 1 },
            new Point { X = 0, Y = 2 })), Is.True);
        Assert.That(scout.IsMoveValid(new KaNoBuMoveResponseModel.MoveStep(
            new Point { X = 1, Y = 1 },
            new Point { X = 0, Y = 0 })), Is.True);
        Assert.That(scout.IsMoveValid(new KaNoBuMoveResponseModel.MoveStep(
            new Point { X = 1, Y = 1 },
            new Point { X = 2, Y = 2 })), Is.True);
        Assert.That(scout.IsMoveValid(new KaNoBuMoveResponseModel.MoveStep(
            new Point { X = 1, Y = 1 },
